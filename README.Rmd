...
- [`R/`](https://github.com/MikeHedde/REFOUND/tree/master/R):
...
Launch the [`make.R`](https://github.com/MikeHedde/REFOUND/tree/master/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/MikeHedde/REFOUND/blob/main/CONTRIBUTING.md).
